...
const BlogCard = (props) => {
  ...
  return (
    <div
      className={`max-w-md rounded overflow-hidden shadow-lg hover:shadow-2xl h-96 relative ${
    ...
    >
      ...
      <div className="px-6 py-4 h-1/6">
        ...
        <div className="text-gray-700 text-base pr-4">
          by {props.username}{" "}
          <div className="inline-block absolute right-0">
            <div className="inline-block pr-3">
              ...
              <a className="pl-1">{longEnUSFormatter.format(props.date)}</a>
            </div>
            <div className="inline-block pr-3">
              <svg
